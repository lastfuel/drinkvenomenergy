const flavors = [
  {
    ...
    className: 'original',
    sku: 'VENOM-Original-12PK-002'
  },
  {
    name: 'FRUIT PUNCH',
    image: 'venom-can-fp.png',
    className: 'fruit-punch',
    sku: 'VENOM-FruitPunch-12PK-004'
  },
  {
    name: 'MANGO',
    image: 'venom-can-m.png',
    className: 'mango',
    sku: 'VENOM-Mango-12PK-003'
  }
];
...
function updateFlavor() {
  ...
  // Update the SKU for the Buy With Prime widget
  const buyNowWidget = document.getElementById('amzn-buy-now');
  buyNowWidget.setAttribute('data-sku', flavors[currentFlavorIndex].sku);
